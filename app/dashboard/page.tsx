  ...
  return (
    <main className="dashboard-page">
      ...
      <section className="dashboard-main">
        ...
        <section className="dashboard-bottom-extras" aria-label="À venir et campagnes récentes">
          ...
          <section className="dashboard-panel campaigns-panel">
            <div className="panel-heading"><h2>Campagnes récentes</h2><a href="/campagnes">Voir tout →</a></div>
            <div className="campaign-list">
              {campaigns.map((campaign) => <div className="campaign-item" key={campaign.title}><img src={campaign.image} alt={`Campagne ${campaign.title}`} /><span><strong>{campaign.title}</strong><small>{campaign.detail}</small><small>{campaign.people}</small></span><b className={campaign.status === "Terminée" ? "done" : "running"}>{campaign.status}</b></div>)}
            </div>
          </section>
        </section>
