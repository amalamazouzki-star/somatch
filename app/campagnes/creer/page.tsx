    ...
    <main className="dashboard-page create-campaign-page">
      ...
      <section className="dashboard-main create-campaign-main">
        ...
        <div className="create-campaign-grid">
          <form className="campaign-information-card" onSubmit={(event) => event.preventDefault()}>
            ...
            <div className="campaign-form-actions"><a href="/campagnes/creer/brief">Continuer<span>→</span></a></div>
          </form>
